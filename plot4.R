...
plot(info1$Voltage ~ info1$Datetime, type="n", ylab="Voltage (volts)", xlab="")
plot(info1$Sub_metering_1 ~ info1$Datetime, type="l",ylab="Global Active Power (kilowatts)", xlab="")
...
plot(info1$Global_reactive_power ~ info1$Datetime, type="l",ylab="Global Rective Power (kilowatts)",xlab="")
